...
export default function SubcontractorPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-32 pb-24 px-4">
      ...
      <div className="relative w-full max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
        ...
        {/* Scrollable Content */}
        <div className="p-8">
          <form action="https://formsubmit.co/kyle@walkergeneralcontractors.ca" method="POST" encType="multipart/form-data" className="space-y-6">
